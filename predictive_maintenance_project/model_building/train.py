...
from huggingface_hub import login, HfApi, create_repo, hf_hub_download # Added hf_hub_download
...
repo_id = "wash9968/predictive-maintainace-prediction"
repo_type = "dataset"

# Download files locally using hf_hub_download to avoid caching issues
Xtrain_local_path = hf_hub_download(repo_id=repo_id, filename="Xtrain.csv", repo_type=repo_type)
Xtest_local_path = hf_hub_download(repo_id=repo_id, filename="Xtest.csv", repo_type=repo_type)
ytrain_local_path = hf_hub_download(repo_id=repo_id, filename="ytrain.csv", repo_type=repo_type)
ytest_local_path = hf_hub_download(repo_id=repo_id, filename="ytest.csv", repo_type=repo_type)
